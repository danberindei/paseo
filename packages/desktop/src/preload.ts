...
contextBridge.exposeInMainWorld("paseoDesktop", {
  ...
  window: {
    ...
    getCurrentWindow: () => ({
      ...
      setTitle: (title: string) => ipcRenderer.invoke("paseo:window:setTitle", title),
    }),
  },
  dialog: {
  ...
  notification: {
    ...
    dismissNotification: (agentId: string) =>
      ipcRenderer.invoke("paseo:notification:dismiss", agentId),
  },
  opener: {
